...
Easy to use script was made: https://github.com/asheroto/winget-install/

Just open PowerShell as Admin and run `irm https://github.com/asheroto/winget-install/releases/latest/download/winget-install.ps1 | iex`.

There's also a bit easier way by getting packages from MSStore (that way .msixbundle won't require license file): https://rentry.co/debloatguide#using-winget-package-manager (method #2).
